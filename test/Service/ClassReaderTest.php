...
class ClassReaderTest extends TestCase
{
    ...
    {
        $factory = $this
            ->getMockBuilder('De\Idrinth\TestGenerator\Factory\ClassDescriptorFactory')
    ...
    public function testParseAndGetResults(ClassReader $reader, SplFileInfo $file, array $result)
    {
        ...
        foreach ($result as $name) {
            ...
            $this->assertInstanceOf('De\Idrinth\TestGenerator\Model\ClassDescriptor', $actual[$name]);
        }
    }
}
